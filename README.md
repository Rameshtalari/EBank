...
<div style="text-align: center;">
    <img src="https://assets.ccbp.in/frontend/content/react-js/ebank-output-v2.gif" alt="output" style="max-width:70%;box-shadow:0 2.8px 2.2px (0, 0, 0, 0.12)">
</div>
...
```json
{
  "jwt_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6Ikp9.eyJ1c2VybmFtZSI6IjE0MjQyMCIsInJvbGUiOiJQUklNRV9VU0VSIiwiaWF0IjoxNjM0MDk4NzYyfQ.2J2zBjRhLVa1EI_4EnkZ-M-7hoVZoZFAu8GTmEQ"
}
```
